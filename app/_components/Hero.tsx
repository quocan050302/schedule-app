...
function Hero() {
  return (
    <section className="relative flex pt-32 pb-32 sm:pb-32 lg:pb-48 px-4 bg-blue-100 w-full md:pb-40 lg:px-16 lg:pt-48 xl:pb-64 h-screen md:px-8 xl:px-24 xxl:px-40">
      <div className="text-center md:text-left md:w-1/2 z-10 xxl:max-w-2xl">
        ...
        <p className="text-base xl:text-xl text-gray-600 mt-4">
          Effortless scheduling made simple
        </p>

        <p className="text-sm xl:text-base text-gray-600 mt-8">
          Scheduly streamlines your scheduling process, removing the hassle of
          back-and-forth emails to find the ideal time — and offers even more
          features to enhance your workflow.
        </p>
        <div className="flex justify-center mt-8 gap-4 flex-wrap md:justify-normal">
          <LoginLink>
            {" "}
            <Button variant="destructive" className="p-7 flex gap-4">
      ...
      <div className="w-full absolute bottom-0 right-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1161.727 456.805">
          <defs>
            <clipPath id="a">
              <path
            ...
            <linearGradient id="s" x1="0.698" y1="0.98" x2="0.324" y2="0.098" />
            <clipPath id="t">
              <path
